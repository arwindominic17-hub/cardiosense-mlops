...
def evaluate_model(model, X_test, y_test, model_name: str, run_id: str = None, threshold: float = 0.5) -> dict:
    ...
    log.info(f"[{model_name}] Accuracy={metrics['accuracy']} "
